...
- **Ph.D. in Geography** — University of California, Santa Barbara *(in progress)*
  ...
  modelling sediment storage and routing in alluvial river corridors.*
- **M.A. in Fluvial Geomorphology** — University of Colorado, Boulder (2023)
  ...
  Rates within Beaver-mediated River Corridors in the Southern Rocky Mountains, USA.*
- **B.A. in Geology** (*summa cum laude*, Phi Beta Kappa) and **B.A. in History**
  (*cum laude*), Minor in GIS — University of California, Davis (2019)

### Research Experience

- **Graduate Researcher**, Water, Vegetation & Society Lab / Surface Processes Lab —
  UC Santa Barbara (Sep 2023–present)
- **Summer Intern**, Imaging Spectroscopy Group — NASA Jet Propulsion Laboratory
  (June 2026–present)
- **Graduate Researcher**, Fluvial Ecogeomorphology Lab — UC Boulder (2021–2023)
- **Water Resources Coordinator**, Water Specialty Group — HDR Engineering (2019–2021)
- **Research Assistant / Undergraduate Researcher** — UC Davis (2017–2019)
...
Sierra Nevada, CA · Dolomites, Italy · Magdalena River, Colombia · Rocky Mountains, CO ·
Cascade Mountains, CA · Northern Japan — geomorphic/hydrologic surveys, sediment coring,
and drone-based monitoring of beaver meadows and restoration.

### Skills

- **Languages:** Python (geopandas, shapely, rasterio, geemap, scikit-learn, whitebox, gdal,
  scipy), R (lidR), JavaScript
- **Software:** Google Earth Engine Python API, ArcGIS Pro, QGIS, HEC-RAS/-LifeSim/-FIA,
  Hazus, ENVI, Affinity Designer
- **Sensors & datasets:** Landsat, Sentinel 1/2, PlanetScope, NAIP, EMIT, SWOT, 3DEP,
  LiDAR/DEMs, HydroSHEDS, GRWL, NASADEM, NLCD, Pekel et al. GSW, DSWE

### Teaching

Lead Teaching Assistant / Teaching Assistant — Landscapes and Water; Intro to GIS;
Global Warming; Quantitative Geomorphology.
